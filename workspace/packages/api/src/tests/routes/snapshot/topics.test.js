...
describe("Topics routes should match expectations", () => {
  let app;
  let cookie = "";
  let testTopicUri = "smoke-testing-vseed";
  ...
  describe("topics.catalog matches expectations", () => {
    ...
    test("topics.catalog matches the snapshot on file", () => {
  ...
  describe("topics.enrollment and topics.verifyCompletion match expectations", () => {
    ...
    test("topics.enrollment matches the snapshot on file", () => {
      expect(enrollmentResponseBody).toMatchSnapshot();
    });

    test("topics.verifyCompletion matches the snapshot on file", () => {
      expect(completionResponseBody).toMatchSnapshot();
    });
  });

  // topics.register is covered in integration tests

  // SKIPPED ENDPOINT: topics.publish
});
